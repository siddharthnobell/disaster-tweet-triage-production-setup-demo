"""Train the MiniLM sentence-embedding candidate (Section B) and evaluate on
val + test.
...
MODEL_PATH = REPO_ROOT / "models" / "candidate.joblib"
METRICS_PATH = REPO_ROOT / "metrics" / "candidate.json"
